...
def render_signature(b, size_key, w, h):
    ...
    if is_landscape:
        ...
        img_box = f"left:0; right:0; top:0; height:{int(h*0.48)}px;"
        scrim = f"background:linear-gradient(180deg, rgba(5,14,34,.15) 0%, rgba(5,14,34,.05) 30%, {NAVY_DEEP} 82%);"
        content_box = f"left:{edge}px; right:{edge}px; top:{int(h*0.42)}px; bottom:{bar_h+int(30*s)}px; display:flex; flex-direction:column; justify-content:flex-start;"
    else:  # square
...
BANNERS = [
    ...
    {"id":"v6_b4", "layout":"signature", "script":5, "title":"Add Healthy Years To Your Life",
     "photo":"real_julie-standing-hd.jpg", "focus":"52% 18%",
     "headline":"Add healthy years<br>to your life.", "cta":"Apply Now"},
    {"id":"v6_b5", "layout":"signature", "script":5, "title":"Live Long Live Strong Be There",
     "photo":"real_julie-purple.jpg", "focus":"50% 15%",
     "headline":"Live long.<br>Live strong.<br>Be there.", "cta":"Enroll Now"},
    {"id":"v6_b6", "layout":"signature", "script":5, "title":"Slow Your Biological Age",
     "photo":"real_julie-hero.jpg", "focus":"78% 30%",
     "headline":"Slow your<br>biological age.", "cta":"Start Today"},

    # ---- 3 ALTERNATE LAYOUTS ----
    {"id":"v6_b7", "layout":"masthead", "script":2, "title":"The Habits That Slow Aging",
     "photo":"real_julie-standing-hd.jpg", "focus":"52% 15%",
     "headline":"The habits that<br>slow aging.", "cta":"Get My Protocol"},
    {"id":"v6_b8", "layout":"splitpanel", "script":5, "title":"More Years More Strength More You",
     "photo":"real_julie-purple.jpg", "focus":"50% 18%",
     "headline":"More years.<br>More strength.<br>More you.", "cta":"Apply Now"},
    {"id":"v6_b9", "layout":"statementcard", "script":2, "title":"Aging Is A Habit Change It",
    ...
    {"id":"v6_b10", "layout":"versus", "script":None, "title":"Julie vs Bryan Johnson",
...
for b in BANNERS:
    ...
    manifest["v6"].append(item)

with open(f"{BANNERS_DIR}/v6_manifest.json", "w") as f:
