...
<div class="canvas">
  <div class="top">
    ...
    <div class="display headline">She Beat Him. Learn Her Method.</div>
  </div>
  <div class="split">
...
BANNERS = [
    # ---- 6 REQUIRED CORE BANNERS (3 x Script 2, 3 x Script 5), signature layout ----
    {"id":"v4_b1", "layout":"signature", "script":2, "title":"Willpower Fails, Habits Don't",
     "photo":"real_julie-standing-hd.jpg", "focus":"52% 18%",
     "headline":"Willpower fails.<br>Habits don&rsquo;t.", "cta":"Build My Protocol"},
    {"id":"v4_b2", "layout":"signature", "script":2, "title":"Make Longevity Automatic",
     "photo":"real_julie-purple.jpg", "focus":"50% 15%",
     "headline":"Make longevity<br>automatic.", "cta":"Start My Blueprint"},
    {"id":"v4_b3", "layout":"signature", "script":2, "title":"Small Habits, Kept For Years",
     "photo":"real_julie-hero.jpg", "focus":"78% 30%",
     "headline":"Small habits.<br>Kept for years.", "cta":"Join the Next Cohort"},
    {"id":"v4_b4", "layout":"signature", "script":5, "title":"It's Not The Years, It's Being There",
     "photo":"real_julie-standing-hd.jpg", "focus":"52% 18%",
     "headline":"It&rsquo;s not the years.<br>It&rsquo;s being there.", "cta":"Apply Now"},
    {"id":"v4_b5", "layout":"signature", "script":5, "title":"Stay Strong For The People Who Need You",
     "photo":"real_julie-purple.jpg", "focus":"50% 15%",
     "headline":"Stay strong for the<br>people who need you.", "cta":"Enroll Now"},
    {"id":"v4_b6", "layout":"signature", "script":5, "title":"Live Longer For Your Reason",
     "photo":"real_julie-hero.jpg", "focus":"78% 30%",
     "headline":"Find your reason.<br>Then live longer for it.", "cta":"Start Today"},

    # ---- 3 ALTERNATE LAYOUTS (same hooks, different structure) ----
    {"id":"v4_b7", "layout":"masthead", "script":2, "title":"Habits That Outlast Willpower",
     "photo":"real_julie-standing-hd.jpg", "focus":"52% 15%",
     "headline":"Habits that outlast<br>willpower.", "cta":"Get My Protocol"},
    {"id":"v4_b8", "layout":"splitpanel", "script":5, "title":"Be There For Them",
     "photo":"real_julie-purple.jpg", "focus":"50% 18%",
     "headline":"Be there for<br>the people who<br>need you.", "cta":"Apply Now"},
    {"id":"v4_b9", "layout":"statementcard", "script":2, "title":"Repeat It Until It's Automatic",
     "photo":"real_julie-standing-hd.jpg", "focus":"52% 10%",
     "headline":"Repeat it until it&rsquo;s<br>automatic.", "cta":"Join the Next Cohort"},

    # ---- BONUS: Julie vs Bryan Johnson ----
    {"id":"v4_b10", "layout":"versus", "script":None, "title":"Julie vs Bryan Johnson",
...
for b in BANNERS:
    ...
    manifest["v4"].append(item)

with open(f"{BANNERS_DIR}/v4_manifest.json", "w") as f:
